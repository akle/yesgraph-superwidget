...
(function() {
    ...
    withScript("jQuery", "https://code.jquery.com/jquery-2.1.1.min.js", function($) {
        ...
        var oldRaven = window.Raven ? window.Raven.noConflict() : undefined,
            _Raven;

        $.getScript("https://cdn.ravenjs.com/3.0.4/raven.js", function(){
            var dsn = "https://5068a9567f46439a8d3f4d3863a1ffce@app.getsentry.com/79999",
                options = {};
            _Raven = window.Raven.noConflict().config(dsn, options).install();
